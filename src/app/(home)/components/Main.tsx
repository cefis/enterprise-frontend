...
export default function Main() {
  ...
  return (
    <div className="py-5 lg:px-44">
      <div className="mx-auto mt-4 max-w-xs border border-gray-500 p-4 lg:max-w-xl">
      ...
      <div className="mx-auto mt-4 flex flex-col items-center justify-center gap-2 text-lg text-gray-400">
        ...
        <Link
          href={'/user'}
          className="flex w-[320px] max-w-sm justify-center border border-gray-600 bg-gray-200 p-2 text-sm font-bold text-gray-400 hover:text-black lg:w-[576px] lg:max-w-xl"
        >
